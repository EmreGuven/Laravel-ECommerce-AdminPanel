            ...
            <div class="row"> <!-- start 3st row -->
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                        <input type="text" name="product_tags" class="form-control" value="Lorem,Ipsum,Amet" data-role="tagsinput" required="" value="{{$products->product_tags}}">
                        @error('product_tags') 
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                        </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                        <input type="text" name="product_size" class="form-control" value="Small,Medium,Large" data-role="tagsinput" required="" value="{{$products->product_size}}">
                        @error('product_size') 
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                        </div>
            ...
            <div class="row"> <!-- start 4st row -->
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                        <input type="text" name="product_color" class="form-control" value="Red,Blue,Yellow" data-role="tagsinput" required="" value="{{$products->product_color}}">
                        @error('product_color') 
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                        </div>
            ...
            <div class="row"> <!-- start 5st row -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                        <textarea name="short_descp" id="textarea" class="form-control" required placeholder="Short Description">{!! $products->short_descp !!}</textarea>
                        </div>
                    </div>
            ...
            <div class="row"> <!-- start 6st row -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                        <textarea id="editor1" name="long_descp" rows="10" cols="80" required="">{!! $products->long_descp !!}</textarea>
                        </div>
                    </div>
...
<br>
    ...
    <div class="col-md-12">
        <div class="box bt-3 border-info">
            <div class="box-header">
            <h4 class="box-title">Product Thumblnail Image <strong>Update</strong></h4>
            </div>
